...
(function(ADL){
    ...
    */
    ...
    XAPIWrapper.prototype.getStatementsAgg = function(searchparams, more, callback)
    {
        if (this.testConfig())
        {
            var url = this.lrs.endpoint + "statements/aggregate";
            if (more)
            {
                url = this.base + more;
            }
